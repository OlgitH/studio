		...
		<>
			...
			<section className="relative max-w-4xl font-light mb-10">
				<Image
					...
					height={1200}
					aria-hidden="true"
					className="absolute bottom-60 -right-40 z-0 w-full max-w-2xl h-auto object-contain opacity-60 pointer-events-none origin-top-right md:w-3/4"
				/>
				<div className="relative z-10">
				<h1 className="text-3xl font-bold mb-4">Website maintenance</h1>
				<p className="mb-4 body-text">We help small businesses build and evolve their website over time, and monitor the performance, so you can be sure you are getting return on investment.
